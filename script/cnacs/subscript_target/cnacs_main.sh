...
do
	...
	if [ ${LOOP} -gt 1 ]; then
		...
		echo "rm ${OUTPUTDIR}/${ID}/tmp/control_info.tmp.txt"
		echo "rm ${OUTPUTDIR}/${ID}/tmp/merged_signal.txt"
		echo "rm ${OUTPUTDIR}/${ID}/tmp/proc_signal.txt"
		echo "rm ${OUTPUTDIR}/${ID}/tmp/reptime2depth.pdf"
		echo "rm ${OUTPUTDIR}/${ID}/tmp/reptime2depth.txt"
		echo "rm ${OUTPUTDIR}/${ID}/tmp/reptime2depth_dip.txt"
		echo "rm ${OUTPUTDIR}/${ID}/tmp/result_pre.txt"
		echo "rm ${OUTPUTDIR}/${ID}/tmp/segment_depth.bed"
		echo "rm ${OUTPUTDIR}/${ID}/tmp/segment_depth.txt"
		echo "rm ${OUTPUTDIR}/${ID}/tmp/segment_pre.txt"
		echo "rm ${OUTPUTDIR}/${ID}/tmp/segment_tmp.bed"
		echo "rm ${OUTPUTDIR}/${ID}/tmp/segment_tmp.txt"
		echo "rm ${OUTPUTDIR}/${ID}/tmp/segment_tmp_pre.txt"
		...
		echo "rm ${OUTPUTDIR}/${ID}/tmp/summary.txt"
		rm ${OUTPUTDIR}/${ID}/tmp/control_depth.tmp.txt
		rm ${OUTPUTDIR}/${ID}/tmp/control_info.tmp.txt
		rm ${OUTPUTDIR}/${ID}/tmp/merged_signal.txt
		rm ${OUTPUTDIR}/${ID}/tmp/proc_signal.txt
		rm ${OUTPUTDIR}/${ID}/tmp/reptime2depth.pdf
		rm ${OUTPUTDIR}/${ID}/tmp/reptime2depth.txt
		rm ${OUTPUTDIR}/${ID}/tmp/reptime2depth_dip.txt
		rm ${OUTPUTDIR}/${ID}/tmp/result_pre.txt
		rm ${OUTPUTDIR}/${ID}/tmp/segment_depth.bed
		rm ${OUTPUTDIR}/${ID}/tmp/segment_depth.txt
		rm ${OUTPUTDIR}/${ID}/tmp/segment_pre.txt
		rm ${OUTPUTDIR}/${ID}/tmp/segment_tmp.bed
		rm ${OUTPUTDIR}/${ID}/tmp/segment_tmp.txt
		rm ${OUTPUTDIR}/${ID}/tmp/segment_tmp_pre.txt
		...
		rm ${OUTPUTDIR}/${ID}/tmp/summary.txt
	fi
	...
	echo "cp -r ${OUTPUTDIR}/${ID}/tmp ${OUTPUTDIR}/${ID}/tmp_${LOOP}"
	cp -r ${OUTPUTDIR}/${ID}/tmp ${OUTPUTDIR}/${ID}/tmp_${LOOP}
done
